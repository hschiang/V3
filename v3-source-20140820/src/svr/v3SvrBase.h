...
class V3SvrBase
{
   public : 
      ...
      virtual void addBoundedVerifyData(const V3NetId&, uint32_t&);
      virtual const bool existVerifyData(const V3NetId&, const uint32_t&);
      void assertBoundedVerifyData(const V3NetVec&, uint32_t&);
   ...
   protected : 
      ...
      void addSimpleBoundedVerifyData(const V3NetId&, uint32_t&);
      // Data Members
