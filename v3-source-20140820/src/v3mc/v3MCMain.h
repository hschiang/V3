...
// V3 Constraints and Invariant Extraction Functions  (v3MCExtract.cpp)
V3NtkHandler* const extractFSMInvariants(V3NtkHandler* const, const double&);
void strengthenFairnessConstraints(V3NtkHandler* const, const V3NetVec&, V3NetVec&);
